...
public class frameMatriz extends javax.swing.JFrame {
 int ngeneral;
	...
	public frameMatriz(int num, Vector<Integer> vector) {
		initComponents();
		ngeneral = num;
		genLista = vector;
	}
	...
	private void initComponents() {
		...
		pnlMenuLayout.setHorizontalGroup(pnlMenuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
				.addGroup(pnlMenuLayout.createSequentialGroup().addGap(150, 150, 150).addComponent(btgenera)
						.addGap(60, 60, 60).addComponent(jSeparator1, javax.swing.GroupLayout.PREFERRED_SIZE, 4,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addGap(0, 0, Short.MAX_VALUE)));
		pnlMenuLayout
				.setVerticalGroup(pnlMenuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
		...
		pnlTableroLayout.setHorizontalGroup(pnlTableroLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 620, Short.MAX_VALUE));
		pnlTableroLayout.setVerticalGroup(pnlTableroLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 620, Short.MAX_VALUE));
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER).addGroup(layout
				...
				.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
						.addGroup(layout.createSequentialGroup()
								.addComponent(pnlTablero, javax.swing.GroupLayout.PREFERRED_SIZE,
	...
	static void main(String args[]) {
		try {
			...
			java.util.logging.Logger.getLogger(frameMatriz.class.getName()).log(java.util.logging.Level.SEVERE, null,
					ex);
